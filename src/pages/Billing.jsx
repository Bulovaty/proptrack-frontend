...
const PLANS = [
  {
    ...
    features: [
      ...
      { label: "Up to 5 photos per listing", included: true },
      { label: "Tenant Browse Portal", included: true },
      { label: "WhatsApp & Call buttons on listings", included: true },
      { label: "CSV bulk tenant import", included: true },
      { label: "Search", included: true },
      { label: "SMS reminders", included: true, note: "30/month cap" },
      { label: "WhatsApp reminders", included: false },
      { label: "Bulk SMS to all tenants", included: false },
      { label: "Booking & viewing requests", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "M-Pesa payment verification", included: true },
      { label: "Vacancy listings with photos", included: true },
      { label: "Up to 10 photos per listing", included: true },
      { label: "Tenant Browse Portal", included: true },
      { label: "WhatsApp & Call buttons on listings", included: true },
      { label: "Booking & viewing requests from tenants", included: true },
      { label: "Inquiry management dashboard", included: true },
      { label: "CSV bulk tenant import", included: true },
      { label: "Search", included: true },
      { label: "SMS reminders", included: true, note: "Unlimited" },
      { label: "WhatsApp reminders", included: true },
      { label: "Bulk SMS & WhatsApp to all tenants", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Booking & viewing requests from tenants", included: true },
      { label: "Inquiry management dashboard", included: true },
      { label: "Featured listings — top of Browse", included: true },
      { label: "Custom listing branding", included: true },
      { label: "CSV bulk tenant import", included: true },
      { label: "Search", included: true },
      { label: "SMS reminders", included: true, note: "Unlimited" },
      { label: "WhatsApp reminders", included: true },
